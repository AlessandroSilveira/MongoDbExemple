...
.PARAMETER Clean
Removes the image mongodbexemple and kills all containers based on that image.
...
Build a Docker image named mongodbexemple
#>
...
$imageName="mongodbexemple"
$projectName="mongodbexemple"
$serviceName="mongodbexemple"
